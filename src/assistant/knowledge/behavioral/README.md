...
Soft-skill and leadership narratives grounded in shipped work (disagreement, review, ownership).

## Layout

| File | Role |
|---|---|
| `behavioral.schema.json` | JSON Schema for documents in this category |
