/**
 * behavioral/loader.js — Lazy knowledge source for category "behavioral".
 */
...
export const SOURCE_ID = 'behavioral.sample';
export const CATEGORY = 'behavioral';
...
export function register(registerSource) {
  registerSource({
    ...
    category: CATEGORY,
    version: VERSION,
    tags: ['sample', 'behavioral'],
    description: 'Behavioral sample pack',
    schemaPath: './behavioral.schema.json',
    meta: { schema },
