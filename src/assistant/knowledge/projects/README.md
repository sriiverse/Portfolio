...
Shipped project facts: problem, solution, stack, decisions, live URLs — one document per project or facet.

## Layout

| File | Role |
|---|---|
| `projects.schema.json` | JSON Schema for documents in this category |
