/**
 * projects/loader.js — Lazy knowledge source for category "projects".
 */
...
export const SOURCE_ID = 'projects.sample';
...
export function register(registerSource) {
  registerSource({
    ...
    description: 'Projects sample pack',
    schemaPath: './projects.schema.json',
    meta: { schema },
