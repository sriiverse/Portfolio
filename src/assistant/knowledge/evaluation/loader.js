/**
 * evaluation/loader.js — Lazy knowledge source for category "evaluation".
 */
...
export const SOURCE_ID = 'evaluation.sample';
...
export function register(registerSource) {
  registerSource({
    ...
    description: 'Evaluation sample pack',
    schemaPath: './evaluation.schema.json',
    meta: { schema },
