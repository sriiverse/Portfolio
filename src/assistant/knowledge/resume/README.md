...
Chronology, roles, education signals, and resume-shaped talking points — not a PDF binary.

## Layout

| File | Role |
|---|---|
| `resume.schema.json` | JSON Schema for documents in this category |
