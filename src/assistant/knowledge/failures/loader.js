/**
 * failures/loader.js — Lazy knowledge source for category "failures".
 */
...
export const SOURCE_ID = 'failures.sample';
export const CATEGORY = 'failures';
...
export function register(registerSource) {
  registerSource({
    ...
    category: CATEGORY,
    version: VERSION,
    tags: ['sample', 'failures'],
    description: 'Failures sample pack',
    schemaPath: './failures.schema.json',
    meta: { schema },
