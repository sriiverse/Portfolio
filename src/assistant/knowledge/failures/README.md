...
Honest failure modes, regrets, and production risk classes — never invented outages.

## Layout

| File | Role |
|---|---|
| `failures.schema.json` | JSON Schema for documents in this category |
