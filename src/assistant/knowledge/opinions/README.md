...
Scoped engineering takes (microservices, TypeScript, retrieval patterns) tied to experience level.

## Layout

| File | Role |
|---|---|
| `opinions.schema.json` | JSON Schema for documents in this category |
